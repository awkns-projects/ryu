...
export function PasswordAuthProvider({ children }: { children: ReactNode }) {
  ...
  const loginAdmin = async (password: string) => {
    try {
      const response = await fetch('/api/go/admin-login', {
        method: 'POST',
  ...
  const register = async (
    ...
    try {
      ...
      const response = await fetch('/api/go/register', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const verifyOTP = async (userID: string, otpCode: string) => {
    try {
      const response = await fetch('/api/go/verify-otp', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const completeRegistration = async (userID: string, otpCode: string) => {
    try {
      const response = await fetch('/api/go/complete-registration', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const resetPassword = async (
    ...
    try {
      const response = await fetch('/api/go/reset-password', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
