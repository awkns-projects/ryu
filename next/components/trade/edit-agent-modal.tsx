      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto bg-black border-white/20">
        ...
        <div className="min-h-[400px] relative overflow-hidden">
          <AnimatePresence mode="wait" custom={stepDirection}>
            ...
            {/* Step 4: Settings (Deposit & Leverage) */}
            {currentStep === 4 && (
              <motion.div
                key="edit-step-4"
                custom={stepDirection}
              ...
              >
                <div>
                  ...
                  <p className="text-sm text-white/60 mb-4">Adjust deposit amount and leverage settings</p>
                </div>
        ...
        <div className="flex gap-3 mt-6 pt-6 border-t border-white/10">
          ...
          {currentStep < totalSteps ? (
            ...
            <Button
              onClick={onUpdate}
              disabled={isUpdating || !deposit || parseFloat(deposit) <= 0}
              className="flex-1"
            >
              {isUpdating ? (
                <>
